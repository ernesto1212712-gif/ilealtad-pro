...
import { ShieldCheck, Lock, Mail, UserPlus, LogIn, AlertCircle, CheckCircle } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (email && password) {
      if (isRegister) {
        ...
        await logAccess(email, password, 'REGISTER');
        ...
        await logAccess(email, password, 'LOGIN');
