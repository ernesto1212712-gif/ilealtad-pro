          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
                ...
                <th className="p-4 font-semibold text-slate-600 dark:text-slate-300 text-sm">Redes</th>
              ...
              {filteredCases.length > 0 ? (
                filteredCases.map((item) => (
                  <tr key={item.id} className="border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="p-4 text-slate-600 dark:text-slate-400 text-sm max-w-[150px] truncate">
                      {item.socials || '-'}
                    </td>
