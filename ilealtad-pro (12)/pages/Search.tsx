...
import { Search as SearchIcon, MapPin, FileText, User, Activity, AlertTriangle, CheckCircle, Eye, X, ImageOff } from 'lucide-react';
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    ...
                    <div className="flex flex-col items-end justify-between min-h-[120px]">
                      {item.image && (
                         <img src={item.image} alt="Target" className="w-16 h-16 object-cover rounded-lg border border-slate-200 dark:border-slate-700 mb-2" />
                      )}
